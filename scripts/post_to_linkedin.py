...
def _build_commentary_prompt(title, content):
    return (
...
def generate_linkedin_commentary(title, content, api_key, provider=DEFAULT_LLM_PROVIDER):
    ...
    """
    prompt = _build_commentary_prompt(title, content)
...
def main():
    ...
    print(f"Generating bilingual LinkedIn commentary with {provider}…")
    commentary, llm_hashtags = generate_linkedin_commentary(
        entry["title"], post_body, api_key, provider=provider
    )
